...
export const Route = createFileRoute("/_authenticated/kuan/pedidos")({
  ...
  return (
    <div className="max-w-3xl mx-auto px-3 sm:px-4 py-6 space-y-4">
      ...
      {!loading && rows.length === 0 && (
        <p className="text-sm text-[color:var(--ivory-dim)]">Nenhum pedido ou orçamento registrado ainda.</p>
      )}
